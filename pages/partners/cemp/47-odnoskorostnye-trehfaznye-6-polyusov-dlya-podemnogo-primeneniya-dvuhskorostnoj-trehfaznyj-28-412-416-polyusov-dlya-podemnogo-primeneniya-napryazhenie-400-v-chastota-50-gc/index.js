                    ...
                    <div className="col-12">
                        ...
                        <table className="table">
                            ...
                            {products.map((item, indexO) => {
                                const pathpage = '47-odnoskorostnye-trehfaznye-6-polyusov-dlya-podemnogo-primeneniya-dvuhskorostnoj-trehfaznyj-28-412-416-polyusov-dlya-podemnogo-primeneniya-napryazhenie-400-v-chastota-50-gc/';
                            return (
                                <tr key={indexO}>
...
export const getServerSideProps = async () => {
    const res = await fetch(
      `http://admin.exd-motors.ru/partners/cemp/categorycemp/47-odnoskorostnye-trehfaznye-6-polyusov-dlya-podemnogo-primeneniya-dvuhskorostnoj-trehfaznyj-28-412-416-polyusov-dlya-podemnogo-primeneniya-napryazhenie-400-v-chastota-50-gc/typeseven/`
    );
    const products = await res.json();
    const res2 = await fetch(
        `http://admin.exd-motors.ru/partners/cemp/categorycemp/47-odnoskorostnye-trehfaznye-6-polyusov-dlya-podemnogo-primeneniya-dvuhskorostnoj-trehfaznyj-28-412-416-polyusov-dlya-podemnogo-primeneniya-napryazhenie-400-v-chastota-50-gc`
      );
