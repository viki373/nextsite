                    ...
                    <div className="col-12">
                        ...
                        <table className="table">
                            ...
                            {products.map((item, indexO) => {
                                const pathpage = '45-dvuhskorostnoj-trehfaznyj-24-48-polyusov-kvadratichnyj-krutyashij-moment-napryazhenie-400-v-chastota-50-gc/';
                            return (
                                <tr key={indexO}>
...
export const getServerSideProps = async () => {
    const res = await fetch(
      `http://admin.exd-motors.ru/partners/cemp/categorycemp/45-dvuhskorostnoj-trehfaznyj-24-48-polyusov-kvadratichnyj-krutyashij-moment-napryazhenie-400-v-chastota-50-gc/typefive/`
    );
    const products = await res.json();
    const rest = await fetch(
        `http://admin.exd-motors.ru/partners/cemp/categorycemp/45-dvuhskorostnoj-trehfaznyj-24-48-polyusov-kvadratichnyj-krutyashij-moment-napryazhenie-400-v-chastota-50-gc`
      );
