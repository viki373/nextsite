...
export const getServerSideProps = async ({params}) => {
    const res = await fetch(
      `http://admin.exd-motors.ru/partners/cemp/categorycemp/45-dvuhskorostnoj-trehfaznyj-24-48-polyusov-kvadratichnyj-krutyashij-moment-napryazhenie-400-v-chastota-50-gc/typefive/${params.slug}`
    );
