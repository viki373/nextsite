...
export const getServerSideProps = async ({params}) => {
    const res = await fetch(
      `http://admin.exd-motors.ru/partners/cemp/categorycemp/44-dvuhskorostnoj-trehfaznyj-24-48-polyusov-postoyannyj-krutyashij-moment-napryazhenie-400-v-chastota-50-gc/typefour/${params.slug}`
    );
