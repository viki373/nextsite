...
export default function Index({products, prod}) {
            ...
            <main className="container mb-5">
                ...
                <div className="row mt-5">
                    <div className="col-12">
                        <h2 className="text-uppercase"> {prod.name}</h2>
                    </div>
                    <div className="col-12">
                        ...
                        <table className="table">
                            ...
                            {products.map((item, indexO) => {
                                const pathpage = '43-odnoskorostnoj-trehfaznyj-2-4-6-8-polyusov-ie3-napryazhenie-400-v-chastota-50-gc/';
                            return (
                                <tr key={indexO}>
...
export const getServerSideProps = async () => {
    const res = await fetch(
      `http://admin.exd-motors.ru/partners/cemp/categorycemp/43-odnoskorostnoj-trehfaznyj-2-4-6-8-polyusov-ie3-napryazhenie-400-v-chastota-50-gc/typethree/`
    );
    const products = await res.json();
    const rest = await fetch(
        `http://admin.exd-motors.ru/partners/cemp/categorycemp/43-odnoskorostnoj-trehfaznyj-2-4-6-8-polyusov-ie3-napryazhenie-400-v-chastota-50-gc`
      );
    const prod = await rest.json();
    return {
      props: {
        products, prod
      },
