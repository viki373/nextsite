...
export const getServerSideProps = async ({params}) => {
    const res = await fetch(
      `http://admin.exd-motors.ru/partners/cemp/categorycemp/43-odnoskorostnoj-trehfaznyj-2-4-6-8-polyusov-ie3-napryazhenie-400-v-chastota-50-gc/typethree/${params.slug}`
    );
