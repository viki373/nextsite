                    ...
                    <div className="col-12">
                        ...
                        <table className="table">
                            ...
                            {products.map((item, indexO) => {
                                const pathpage = '48-pitaemye-invertorom-napryazhenie-400-v-chastota-50-gc/';
                            return (
                                <tr key={indexO}>
...
export const getServerSideProps = async () => {
    const res = await fetch(
      `http://admin.exd-motors.ru/partners/cemp/categorycemp/48-pitaemye-invertorom-napryazhenie-400-v-chastota-50-gc/typeeight/`
    );
    const products = await res.json();
    const res2 = await fetch(
        `http://admin.exd-motors.ru/partners/cemp/categorycemp/48-pitaemye-invertorom-napryazhenie-400-v-chastota-50-gc`
      );
