...
export const getServerSideProps = async ({params}) => {
    const res = await fetch(
      `http://admin.exd-motors.ru/partners/cemp/categorycemp/42-odnoskorostnoj-trehfaznyj-2-4-6-8-polyusov-ie2-napryazhenie-400-v-chastota-50-gc/typetwo/${params.slug}`
    );
