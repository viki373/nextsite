                    ...
                    <div className="col-12">
                        ...
                        <table className="table">
                            ...
                            {products.map((item, indexO) => {
                                const pathpage = '42-odnoskorostnoj-trehfaznyj-2-4-6-8-polyusov-ie2-napryazhenie-400-v-chastota-50-gc/';
                            return (
                                <tr key={indexO}>
...
export const getServerSideProps = async () => {
    const res = await fetch(
      `http://admin.exd-motors.ru/partners/cemp/categorycemp/42-odnoskorostnoj-trehfaznyj-2-4-6-8-polyusov-ie2-napryazhenie-400-v-chastota-50-gc/typetwo`
    );
    const products = await res.json();

    const res2 = await fetch(
        `http://admin.exd-motors.ru/partners/cemp/categorycemp/42-odnoskorostnoj-trehfaznyj-2-4-6-8-polyusov-ie2-napryazhenie-400-v-chastota-50-gc`
      );
