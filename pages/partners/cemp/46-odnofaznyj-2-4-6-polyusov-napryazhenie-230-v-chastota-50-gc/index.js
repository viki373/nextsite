                    ...
                    <div className="col-12">
                        ...
                        <table className="table">
                            ...
                            {products.map((item, indexO) => {
                                const pathpage = '46-odnofaznyj-2-4-6-polyusov-napryazhenie-230-v-chastota-50-gc/';
                            return (
                                <tr key={indexO}>
...
export const getServerSideProps = async () => {
    const res = await fetch(
      `http://admin.exd-motors.ru/partners/cemp/categorycemp/46-odnofaznyj-2-4-6-polyusov-napryazhenie-230-v-chastota-50-gc/typesix/`
    );
    const products = await res.json();
    const res2 = await fetch(
        `http://admin.exd-motors.ru/partners/cemp/categorycemp/46-odnofaznyj-2-4-6-polyusov-napryazhenie-230-v-chastota-50-gc`
      );
