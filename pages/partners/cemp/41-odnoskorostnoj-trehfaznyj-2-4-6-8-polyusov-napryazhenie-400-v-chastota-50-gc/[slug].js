...
const Type = ({item}) => {
    ...
    const newAr16 = newArray[16].split(':');
    const newAr17 = newArray[17].split(':');
    const newAr18 = newArray[18].split(':');
    const newAr19 = newArray[19].split(':');
    const newAr20 = newArray[20].split(':');
    const newAr21 = newArray[21].split(':');
    return (
    <>
            <Head />
                ...
                <div className="row">
                    <div className="col-12 col-lg-9 m-auto">
                            ...
                            <tbody>
                                ...
                                <tr>
                                <td><strong>{newAr16[0]}</strong></td>
                                <td>{newAr16[1]}</td>
                                </tr>
                                <tr>
                                <td><strong>{newAr17[0]}</strong></td>
                                <td>{newAr17[1]}</td>
                                </tr>
                                <tr>
                                <td><strong>{newAr18[0]}</strong></td>
                                <td>{newAr18[1]}</td>
                                </tr>
                                <tr>
                                <td><strong>{newAr19[0]}</strong></td>
                                <td>{newAr19[1]}</td>
                                </tr>
                                <tr>
                                <td><strong>{newAr20[0]}</strong></td>
                                <td>{newAr20[1]}</td>
                                </tr>
                                <tr>
                                <td><strong>{newAr21[0]}</strong></td>
                                <td>{newAr21[1]}</td>
                                </tr>
                            </tbody>
                        </table>  
...
export const getServerSideProps = async ({params}) => {
    ...
    const res = await fetch(
      `http://admin.exd-motors.ru/partners/cemp/categorycemp/41-odnoskorostnoj-trehfaznyj-2-4-6-8-polyusov-napryazhenie-400-v-chastota-50-gc/type/${params.slug}`
    );
