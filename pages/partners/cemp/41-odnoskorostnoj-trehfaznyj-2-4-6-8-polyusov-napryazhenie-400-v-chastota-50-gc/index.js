...
export default function Index({products, cat}) {
                    ...
                    <div className="col-12">
                        ...
                        <table className="table">
                            ...
                            {products.map((item, indexO) => {
                                const pathpage = '41-odnoskorostnoj-trehfaznyj-2-4-6-8-polyusov-napryazhenie-400-v-chastota-50-gc/';
                            return (
                                <tr key={indexO}>
  ...
  export const getServerSideProps = async () => {
    const res = await fetch(
      `http://admin.exd-motors.ru/partners/cemp/categorycemp/41-odnoskorostnoj-trehfaznyj-2-4-6-8-polyusov-napryazhenie-400-v-chastota-50-gc/type/`
    );
    const products = await res.json();
    const res1 = await fetch(
        `http://admin.exd-motors.ru/partners/cemp/categorycemp/41-odnoskorostnoj-trehfaznyj-2-4-6-8-polyusov-napryazhenie-400-v-chastota-50-gc`
      );
